...
#     Susi              wants the bike from 06 to 10
...
myFriends = ["Chamo", "Villegas", "Canaval", "Medina", "Susi", "Juanka", "Piti", "Carlos Vives", "El Bisho"]
...
myFriends = ["Villegas", "Canaval", "Medina", "Susi", "Chamo", "Juanka", "Carlos Vives", "El Bisho", "Piti"]
solucion = []
